            ...
            <form class="ct-w-full ct-px-2 ct-pt-10 ct-flex ct-flex-col" @submit.prevent="addRequestedFeatures()">
                <div class="ct-mb-20">
                    ...
                    <div class="ct-flex ct-flex-col ct-mb-4">
                        ...
                        <input type="text" name="requestname" class="ct-shadow ct-appearance-none ct-w-full ct-bg-white ct-text-gray-700 ct-border ct-border-gray-500 ct-rounded ct-py-3 ct-px-4 ct-mb-3 ct-focus:outline-none ct-focus:bg-white" id="requestname" v-model="data.requestName">
                    </div>
                    <div class="ct-flex ct-flex-col">
                        ...
                        <input type="text" name="votingtime" class="ct-shadow ct-appearance-none ct-w-full ct-bg-white ct-text-gray-700 ct-border ct-border-gray-500 ct-rounded ct-py-3 ct-px-4 ct-mb-3 ct-focus:outline-none ct-focus:bg-white" id="votingtime" v-model="data.votingTime">
                    </div>
                </div>
